...
void CPlayer::Render() {
	if (mEnabled == true) {	
		...
		if (Gender == 1) {
			...
			if (mFx >= 0) {
				if (JumpFlg == true) {
					CRectangle::Render(PlayerGirlJump1, 228 - 48 + 400 * (JumpMotion % 5), 228 + 48 + 400 * (JumpMotion % 5), 209 + 111 + 300 * (JumpMotion / 5), 209 - 111 + 300 * (JumpMotion / 5));
				}
				else {
					CRectangle::Render(PlayerGirlJump1, 228 - 48, 228 + 48, 209 + 111, 209 - 111);
				}
